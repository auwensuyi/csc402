...
class HW2 {
    ...
    public static double sumHelper (double[] arr, double tally, int i) {
    	 if(i < arr.length){
            return sumHelper(arr, tally += arr[i], ++i);
        }
        return tally;
    }
    ...
    public static void reverseHelper (double[] a, int i) {
    	if(i < a.length / 2){
            double front = a[i];
            double back = a[(a.length - 1) - i];
            a[i] = back;
            a[(a.length - 1) - i] = front;
            reverseHelper(a, ++i);
        }
    }
...
//Sample output code
/**total (15): 15.000000
[5.0, 4.0, 2.0, 3.0, 3.0, 2.0, 1.0]
terribleFibonacci( 0)=0
terribleFibonacci( 1)=1
terribleFibonacci( 2)=1
terribleFibonacci( 3)=2
terribleFibonacci( 4)=3
terribleFibonacci( 5)=5
terribleFibonacci( 6)=8
terribleFibonacci( 7)=13
terribleFibonacci( 8)=21
terribleFibonacci( 9)=34
terribleFibonacci(10)=55
terribleFibonacci(11)=89
terribleFibonacci(12)=144
terribleFibonacci(13)=233
terribleFibonacci(14)=377
terribleFibonacci(15)=610
fibonacci( 0)=0
fibonacci( 1)=1
fibonacci( 2)=1
fibonacci( 3)=2
...
/** Everything works based on the sample output code.
fibonacci code ran more effectively than terribleFibonacci.
terribleFibonacci(56)=225851433717 took an hour. fibonacci(54) took 14 minutes
